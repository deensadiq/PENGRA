...
Namespace cForm
    Public Class frmFindUsers
        ...
        Private Sub rbStudentName_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles rbFullName.Click
            F.bUserName = False
            ShowView()
        End Sub

        Private Sub rbAdmissionNo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles rbUsername.Click
            F.bUserName = True
            ShowView()
        End Sub
