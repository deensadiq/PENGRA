...
Namespace Forms
    Public Class frmOutStandingAL
        ...
        Private Sub CreateSQLString()
            ...
            If cboStatus.Text <> "" Then
                ...
                If iBenefit = 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQL = strSQL + " p.GRATUITYPAID, p.PEANSIONPAID, p.DEATHPAID, p.TOTALPAID, p.BALANCE, p.STATUS FROM SP_BENEFICIARIES_ABOVELIMIT p  WHERE p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"
                    ...
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "' ORDER BY EXTRACT(YEAR FROM DOAA) DESC, EXTRACT(MONTH FROM DOAA) DESC"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQL = strSQL + " p.MONTHNAME || ' ' || P.AYEAR AS DESCRIPTION, p.GRATUITY, p.PENSIONARREARS, p.DEATHPENSION, p.TOTALBENEFIT,"
                    strSQL = strSQL + " p.GRATUITYPAID, p.PEANSIONPAID, p.DEATHPAID, p.TOTALPAID, p.BALANCE, p.STATUS FROM SP_BENEFICIARIES_ABOVELIMIT p "
                    strSQL = strSQL + " WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "' ORDER BY p.AYEAR, p.AMONTH, p.EMPLOYEENAME"

                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS = '" & iStatus & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS = '" & iStatus & "' AND STATUS >= '" & userStatus & "'"


                End If
            Else
                '======================================================================================================================================
                '=====================================================No Status Value Is Provided======================================================
                '======================================================================================================================================
                If iBenefit = 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                    'No Filter Attribute: Load All Data From Table
                    strSQL = "SELECT p.SN, p.ID, p.EMPLOYEE, p.EMPLOYEENAME, p.MINISTRYNAME, p.BTYPE, p.TRANSTYPE, p.AYEAR, p.AMONTH, "
                    strSQL = strSQL + " p.MONTHNAME || ' ' || P.AYEAR AS DESCRIPTION, p.GRATUITY, p.PENSIONARREARS, p.DEATHPENSION, p.TOTALBENEFIT,"
                    strSQL = strSQL + " p.GRATUITYPAID, p.PEANSIONPAID, p.DEATHPAID, p.TOTALPAID, p.BALANCE, p.STATUS FROM SP_BENEFICIARIES_ABOVELIMIT p  WHERE p.STATUS >= '" & userStatus & "'"
                    strSQL = strSQL + " ORDER BY p.AYEAR, p.AMONTH, p.EMPLOYEENAME"

                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND STATUS >= '" & userStatus & "' ORDER BY EXTRACT(YEAR FROM DOAA) DESC, EXTRACT(MONTH FROM DOAA) DESC"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & userStatus & "'"
                ...
                ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                    ...
                    strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                    strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                    strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & userStatus & "'"

                    strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & userStatus & "'"
        ...
        Private Sub setPrivilege()
            If Users.Privilege.EditRetireeStatusAL = False Then
                btnEdit.Visible = False
                btnSave.Visible = False
                btnUndo.Visible = False
            End If

            If Users.Privilege.GenerateOustandingReportAL = False Then
