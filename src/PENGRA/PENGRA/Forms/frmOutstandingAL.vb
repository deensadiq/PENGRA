    ...
    Public Class frmOutStandingAL
        ...
        Private Sub CreateSQLString()
            ...
            If iBenefit = 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                ...
                strSQL = strSQL + " p.GRATUITYPAID, p.PEANSIONPAID, p.DEATHPAID, p.TOTALPAID, p.BALANCE, p.STATUS FROM SP_BENEFICIARIES_ABOVELIMIT p  WHERE p.STATUS >= '" & iStatus & "'"
                ...
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND STATUS >= '" & iStatus & "' ORDER BY EXTRACT(YEAR FROM DOAA) DESC, EXTRACT(MONTH FROM DOAA) DESC"
            ...
            ElseIf iBenefit <> 0 And iMinistry = 0 And iYear = 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit = 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear = 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit = 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth = 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit <> 0 And iMinistry = 0 And iYear <> 0 And iMonth <> 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit = 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & iStatus & "'"
            ...
            ElseIf iBenefit <> 0 And iMinistry <> 0 And iYear <> 0 And iMonth <> 0 Then
                ...
                strSQLTotal = "SELECT SUM(p.GRATUITY) AS GRATUITY, SUM(p.PENSIONARREARS) AS PENSIONARREARS, SUM(p.DEATHPENSION) AS DEATHPENSION, SUM(p.TOTALBENEFIT) AS TOTALBENEFIT, "
                strSQLTotal = strSQLTotal + " SUM(p.GRATUITYPAID) AS GRATUITYPAID, SUM(p.PEANSIONPAID) AS PEANSIONPAID, SUM(p.DEATHPAID) AS DEATHPAID, SUM(p.TOTALPAID) AS TOTALPAID, SUM(p.BALANCE) AS BALANCE"
                strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_ABOVELIMIT p WHERE p.BTYPE = '" & iBenefit & "' AND p.MINISTRY = '" & iMinistry & "' AND p.AYEAR = '" & iYear & "' AND p.AMONTH = '" & iMonth & "' AND p.STATUS >= '" & iStatus & "'"

                strEmployee = "SELECT * FROM EMPLOYEEINFO WHERE LIMIT = '0' AND ACTVE = '1' AND BENEFITTYPE = '" & iBenefit & "' AND MINISTRY = '" & iMinistry & "' AND EXTRACT(YEAR FROM DOAA) = '" & iYear & "' AND EXTRACT(MONTH FROM DOAA) = '" & iMonth & "' AND STATUS >= '" & iStatus & "'"
