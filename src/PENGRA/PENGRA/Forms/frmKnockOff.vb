...
Namespace Forms
    Public Class frmKnockOff
        ...
        Sub LoadData(ByVal Employee As Integer)
            ...
            End If
        End Sub
        Sub LoadDataByUkey(ByVal IDNo As String)
            Dim da As FbDataAdapter
            Dim tbl As New DataTable
            Dim str As String
            ...
            str = "SELECT * FROM EMPLOYEEINFO a WHERE IDNO = '" & IDNo & "'"
            da = New FbDataAdapter(str, DB.ConnObj)
            da.Fill(tbl)
        ...
        Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
            If txtFullName.Text = "" Then Exit Sub
        ...
        Private Function IsSaveValid() As Boolean
            ...
            If CDbl(txtKnockoffAmount.Text) > CDbl(txtBalance.Text) Then
                MessageBox.Show(Messages.AmountOver, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Stop)
                txtKnockoffAmount.Focus()
                Return False
            End If
        ...
        Private Sub txtID_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtID.KeyUp
            ...
            If e.KeyCode = Keys.Enter Then
                LoadDataByUkey(txtID.Text.Trim)
            End If
        End Sub
        ...
        Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
            ...
            If F.CancelRecord = False Then
                clearForm()
                LoadData(F.EmployeeID.ToString)
            End If
        End Sub
    End Class
End Namespace