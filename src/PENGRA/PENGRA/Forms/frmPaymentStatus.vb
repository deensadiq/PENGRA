...
Namespace Forms
    Public Class frmPaymentStatus
        ...
        Private Sub InitGrid(ByVal Employee As Integer)
            ...
            strSQL = "SELECT p.SN, p.TDATE, p.BUDGET, p.BENEFIT, p.DESCRIPTION, p.AMOUNT FROM SP_PAYMENT_HISTORY('" & Employee & "') p"
            ...
            With dgvGrid
                ...
                Populate.WriteColumn(dgvGrid, "cBudget", "ALLOCATION", 150, DataGridViewTriState.False, DataGridViewContentAlignment.MiddleLeft)
                Populate.WriteColumn(dgvGrid, "cBenefit", "BENEFIT", 120, DataGridViewTriState.False, DataGridViewContentAlignment.MiddleLeft)
                Populate.WriteColumn(dgvGrid, "cDescription", "DESCRIPTION", 120, DataGridViewTriState.False, DataGridViewContentAlignment.MiddleLeft)
                ...
                .Columns(2).DataPropertyName = "BUDGET"
        ...
        Private Sub CButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Me.Close()
        End Sub
