...
Namespace Forms
    ...
    Public Class frmPaymentDetailsAL
        Dim I As Integer
        ...
        Private Function CreateSQLString(ByVal str As String) As String
            ...
            str = str + " WHERE a.BUDGET = '" & Budget & "' AND a.BYEAR = '" & BYear & "' AND a.BMONTH = '" & BMonth & "' AND a.TTYPE = '0' ORDER BY a.BENEFICIARY, b.FULLNAME"
        ...
        Private Sub LoadGrid(ByVal Grid As DataGridView)
            ...
            strSQL = "SELECT * FROM TRANSACTIONS WHERE BUDGET = '" & Budget & "' AND BYEAR = '" & BYear & "' AND BMONTH = '" & BMonth & "' AND TTYPE = '0'"
        ...
        Private Sub LoadTotal(ByVal Grid As DataGridView)
            ...
            strSQL = "SELECT SUM(a.DEBIT) FROM TRANSACTIONS a WHERE a.BUDGET = '" & Budget & "' AND a.BYEAR = '" & BYear & "' AND a.BMONTH = '" & BMonth & "' AND a.TTYPE = '0'"
        ...
        Private Sub setPrivilege()
            ...
            If Users.Privilege.RemovePaymentAL = False Then
        ...
        Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
            If Users.Privilege.RemovePaymentAL = False Or (Env.UserStatus <> Table.Rows(dgvGrid.CurrentRow.Index).Item("STATUS").ToString) Then
                MessageBox.Show(Messages.NoPrivilege, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Exit Sub
            End If
