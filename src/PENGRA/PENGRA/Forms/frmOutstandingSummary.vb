...
Namespace Forms
    ...
    Public Class frmOutstandingSummary
        ...
        Private Sub CreateSQLString()
            ...
            strSQL = strSQL + " FROM SP_BENEFICIARIES_OUTSTANDING p WHERE p.STATUS = '2' GROUP BY p.AYEAR, p.AMONTH ORDER BY p.AYEAR, p.AMONTH"
            ...
            strSQLTotal = strSQLTotal + " FROM SP_BENEFICIARIES_OUTSTANDING p WHERE p.STATUS = '2'"
        End Sub
        ...
        Private Sub setPrivilege()
            If Users.Privilege.GenerateSummaryReport = False Then
