...
!define oIcon "ICON-24x24.ico"
!define oUnIcon "uninstallICON-24x24.ico"
...
; SectionGroup "Administrative Tools"
  ; Section /o "Report Manager" Report
          ; File "${oTools}reportman2_7a.exe"
          ; ExecWait "$INSTDIR\reportman2_7a.exe"
  ; SectionEnd
  ; Section /o "Firebird RDBMS" Firebird
          ; File "${oTools}Firebird-2.0.0.12748-0-Win32.exe"
          ; ExecWait "$INSTDIR\Firebird-2.0.0.12748-0-Win32.exe"
  ; SectionEnd
  ; Section /o "CardPro" CardPro
          ; File "${oTools}CardProFiles.exe"
          ; ExecWait "$INSTDIR\CardProFiles.exe"
  ; SectionEnd
; SectionGroupEnd

; SectionGroup "Add Ins"
  ; Section /o "Themes" Theme

  ; SectionEnd
  ; Section /o "Videos" Video
  ; SectionEnd
  ; Section /o "Tutorials" Tutorial
  ; SectionEnd
; SectionGroupEnd
